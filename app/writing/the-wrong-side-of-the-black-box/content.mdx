i’m not being dramatic when i say i dreamt about this. i’d spent a whole day fighting a model to give me clean json, went to sleep annoyed, and dreamt of a version that skipped the words entirely and handed me the answer with a number next to it. then i found typesafe ai.
...
chat models are great, i use them daily. but we started calling them from code like they’re a function that returns something reliable. they aren’t. they’re trained to write for a human reader.
