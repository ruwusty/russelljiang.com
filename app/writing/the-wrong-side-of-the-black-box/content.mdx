...
caveats: it’s waitlisted, the architecture isn’t published, the headline benchmarks are their own, and the one outside test so far found it fast and cheap but a bit less accurate than a frontier model. “can’t hallucinate” means it can’t return a malformed answer, not that it’s never wrong.
